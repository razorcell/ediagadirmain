jQuery(document).ready(function () {
	...
	$('#reload_table').click(loadDatatables);
	$('.select2').on('change', loadDatatables);
		...
		$.ajax({
			...
			success: function (response, textStatus, jqXHR) {
				...
				browser_data_datatables_object = $('#browser_data_datatables_dom').dataTable({
					...
					"serverSide": true,
					"ajax": {
						"url": "datatables_Server_Processing.php",
						"type": "POST",
						"data": function (d) {
							d.source = source;
					...
					// "ajax": "datatables_Server_Processing.php",
					...
					"lengthMenu": [
						[10, 20, 30, 50, 80, 100, 200, 300, 400, 500, -1],
						[10, 20, 30, 50, 80, 100, 200, 300, 400, 500, "All"] // change per page values here
					],
