...
class DBMEEKRO
{
  ...
  public static function getMDB()
  {
    ...
    $db_class_vars = get_class_vars('DBMEEKRO'); // the DBMEEKRO::$$var syntax only works in 5.3+
  ...
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'get'), $args);
  }
  public static function disconnect()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'disconnect'), $args);
  }
  public static function query()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'query'), $args);
  }
  public static function queryFirstRow()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryFirstRow'), $args);
  }
  public static function queryOneRow()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryOneRow'), $args);
  }
  public static function queryAllLists()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryAllLists'), $args);
  }
  public static function queryFullColumns()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryFullColumns'), $args);
  }
  public static function queryFirstList()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryFirstList'), $args);
  }
  public static function queryOneList()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryOneList'), $args);
  }
  public static function queryFirstColumn()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryFirstColumn'), $args);
  }
  public static function queryOneColumn()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryOneColumn'), $args);
  }
  public static function queryFirstField()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryFirstField'), $args);
  }
  public static function queryOneField()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryOneField'), $args);
  }
  public static function queryRaw()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryRaw'), $args);
  }
  public static function queryRawUnbuf()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'queryRawUnbuf'), $args);
  }

  public static function insert()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'insert'), $args);
  }
  public static function insertIgnore()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'insertIgnore'), $args);
  }
  public static function insertUpdate()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'insertUpdate'), $args);
  }
  public static function replace()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'replace'), $args);
  }
  public static function update()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'update'), $args);
  }
  public static function delete()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'delete'), $args);
  }

  public static function insertId()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'insertId'), $args);
  }
  public static function count()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'count'), $args);
  }
  public static function affectedRows()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'affectedRows'), $args);
  }

  public static function useDB()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'useDB'), $args);
  }
  public static function startTransaction()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'startTransaction'), $args);
  }
  public static function commit()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'commit'), $args);
  }
  public static function rollback()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'rollback'), $args);
  }
  public static function tableList()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'tableList'), $args);
  }
  public static function columnList()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'columnList'), $args);
  }

  public static function sqlEval()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'sqlEval'), $args);
  }
  public static function nonSQLError()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'nonSQLError'), $args);
  }

  public static function serverVersion()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'serverVersion'), $args);
  }
  public static function transactionDepth()
  {
    $args = func_get_args();
    return call_user_func_array(array(DBMEEKRO::getMDB(), 'transactionDepth'), $args);
  }


  public static function debugMode($handler = true)
  {
    DBMEEKRO::$success_handler = $handler;
  }
}
...
class MeekroDB
{
  ...
  {
    if ($host === null) $host = DBMEEKRO::$host;
    if ($user === null) $user = DBMEEKRO::$user;
    if ($password === null) $password = DBMEEKRO::$password;
    if ($dbName === null) $dbName = DBMEEKRO::$dbName;
    if ($port === null) $port = DBMEEKRO::$port;
    if ($encoding === null) $encoding = DBMEEKRO::$encoding;
  ...
  {
    $DBMEEKRO = $this->get();
    if (!$DBMEEKRO->select_db($dbName)) $this->nonSQLError("Unable to set database to $dbName");
  ...
  public function tableList($DBMEEKRO = null)
  {
    if ($DBMEEKRO) {
  ...
  protected function queryHelper()
  {
    ...
    $result = $DBMEEKRO->query($sql, $is_buffered ? MYSQLI_STORE_RESULT : MYSQLI_USE_RESULT);
    if ($this->success_handler) $runtime = microtime(true) - $starttime;
    else $runtime = 0;

    // ----- BEGIN ERROR HANDLING
    if (!$sql || $DBMEEKRO->error) {
      if ($this->error_handler) {
        ...
        call_user_func($error_handler, array(
          'type' => 'sql',
          'query' => $sql,
          'error' => $DBMEEKRO->error,
          'code' => $DBMEEKRO->errno
        ));
      }

      if ($this->throw_exception_on_error) {
        $e = new MeekroDBException($DBMEEKRO->error, $sql, $DBMEEKRO->errno);
        throw $e;
      }
      ...
      call_user_func($success_handler, array(
        'query' => $sql,
        'runtime' => $runtime,
        'affected' => $DBMEEKRO->affected_rows
      ));
    }

    // ----- END ERROR HANDLING

    $this->insert_id = $DBMEEKRO->insert_id;
    $this->affected_rows = $DBMEEKRO->affected_rows;
    ...
    // free results
    $result->free();
    while ($DBMEEKRO->more_results()) {
      $DBMEEKRO->next_result();
      if ($result = $DBMEEKRO->use_result()) $result->free();
    }
...
class WhereClause
{
  ...
  function __construct($type)
  {
    ...
    if ($type !== 'or' && $type !== 'and') DBMEEKRO::nonSQLError('you must use either WhereClause(and) or WhereClause(or)');
    $this->type = $type;
  }
...
class DBTransaction
{
  ...
  {
    DBMEEKRO::startTransaction();
  }
  function __destruct()
  {
    if (!$this->committed) DBMEEKRO::rollback();
  }
  function commit()
  {
    DBMEEKRO::commit();
